...
feature1 = st.number_input("Patient Id", min_value=0.0, format="%.2f")
feature2 = st.number_input("Age", min_value=0.0, format="%.2f")
feature3 = st.number_input("Air Pollution", min_value=0.0, format="%.2f")
feature4 = st.number_input("Alcohol use", min_value=0.0, format="%.2f")
feature5 = st.number_input("Dust Allergy", min_value=0.0, format="%.2f")
feature6 = st.number_input("Occupation", min_value=0.0, format="%.2f")
feature7 = st.number_input("Gnetic Risk", min_value=0.0, format="%.2f")
...
feature24 = st.number_input("Gender", min_value=0.0, format="%.2f")
feature25 = st.number_input("Index", min_value=0.0, format="%.2f")
